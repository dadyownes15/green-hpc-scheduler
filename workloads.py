...
EPISODE_LENGTH = config.getint('training','episode_length', fallback=100)
...
class Workloads:
    ...
    def __init__(self, path):
        ...
        with open(path) as fp:
            for line in fp:
                ...
                j.power_usage = CONSTANT_POWER_PER_PROCESSOR * j.request_number_of_processors
    ...
    def reset(self, start_job_offset):
        ...
        for idx in range(start_job_offset, start_job_offset + EPISODE_LENGTH):
        ...
        assert len(self.episode_jobs) == EPISODE_LENGTH

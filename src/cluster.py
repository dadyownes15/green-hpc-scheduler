...
class Cluster:
    def __init__(self, node_num, num_procs_per_node, idlePower):
        self.total_node = node_num
        self.free_node = node_num
        self.used_node = 0
        self.num_procs_per_node = num_procs_per_node
        self.all_nodes = []
        self.statPower = idlePower*math.ceil(self.total_node / num_procs_per_node)
    ...
    def can_allocated(self, job : Job):
